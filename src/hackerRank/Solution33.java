...
/*
	Write a class called MyRegex which will contain a string pattern. You need to write a regular expression and assign it to the pattern such that 
	...
	In this problem you will be provided strings containing any combination of ASCII characters. You have to write a regular expression to find 
	the valid IPs.
...
class MyRegex {
	public final String pattern = "^(([01]?\\d{1,2}|2[0-4]\\d|25[0-5])\\.){3}([01]?\\d{0,2}|2[0-4]\\d|25[0-5])$";
}
